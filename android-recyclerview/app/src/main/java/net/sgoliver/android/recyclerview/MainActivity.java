...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=1; i<11; i++)
            datos.add(new Alumno("Alumno " + i, "Apellidos item " + i));
        ...
        btnInsertar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                datos.add(0, new Alumno("Nuevo Alumno", "Subtitulo nuevo titular"));
        ...
        btnMover.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Alumno aux = datos.get(0);
                datos.set(0,datos.get(1));
                datos.set(1,aux);

                adaptador.notifyItemMoved(0, 1);
            }
        });
    }
